...
contract SwapApp {
    ...
    event ETHForTokensSwap(
        address indexed user,
        address indexed tokenOut,
        uint256 amountIn,
        uint256 amountOut
    );
    event tokensForETHSwap(
        address indexed user,
        address indexed tokenIn,
        uint256 amountIn,
        uint256 amountOut
    ...
    function swapTokens(
        ...
        uint256[] memory amountsOut = IV2Router(V2Router02Address)
    ...
    function getAmountOutHelper(
        uint amountIn_,
        address[] calldata path_
    ) public view returns (uint amountOut) {
        uint[] memory amounts = IV2Router(V2Router02Address).getAmountsOut(
            amountIn_,
            path_
        );
